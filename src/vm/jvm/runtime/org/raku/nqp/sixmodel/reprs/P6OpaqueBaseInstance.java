...
public class P6OpaqueBaseInstance extends SixModelObject {
    ...
    private VarHandle attributeVarHandle(SixModelObject class_handle, String name) {
        try {
    ...
    public SixModelObject cas_attribute_boxed(ThreadContext tc, SixModelObject class_handle,
        ...
        VarHandle vh = attributeVarHandle(class_handle, name);
        return vh.compareAndSet(this, expected, value)
            ? expected
            : (SixModelObject)vh.getVolatile(this);
    }
