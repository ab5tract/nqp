...
public class CStruct extends REPR {
    ...
    public void compose(ThreadContext tc, STable st, SixModelObject repr_info_hash) {
        ...
        List<CStructREPRData.AttrInfo> attrInfos = new ArrayList<CStructREPRData.AttrInfo>();
        for (long i = mroLength - 1; i >= 0; i--) {
            ...
            if (parents <= 1) {
                ...
                for (long j = 0; j < numAttrs; j++) {
                    ...
                    CStructREPRData.AttrInfo info    = new CStructREPRData.AttrInfo();
    ...
    private void generateStructClass(ThreadContext tc, STable st, List<CStructREPRData.AttrInfo> fields) {
        ...
        for (CStructREPRData.AttrInfo info: fields) {
    ...
    private String typeDescriptor(ThreadContext tc, CStructREPRData.AttrInfo info) {
