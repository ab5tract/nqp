...
object NqpTypeOps {
     ...
     */
    internal fun republished(site: Site) {
        CompilerDirectives.transferToInterpreterAndInvalidate()
    ...
    @TruffleBoundary
    internal fun debug(msg: String) { System.err.println("jesp: $msg") }
    ...
    @TruffleBoundary
    internal fun suspendedIn(sse: SaveStackException,
    ...
    internal fun truthy(v: Any?, tc: ThreadContext): Long =
